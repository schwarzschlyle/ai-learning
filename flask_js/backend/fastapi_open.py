...
def generate_email(email_request: EmailRequest, db: Session = Depends(get_db)):
    """
    Generate a professional email for a contact using semantic search and OpenAI's ChatCompletion.
    """
    try:
        ...
        prompt = (
            f"You are a professional email assistant. Please compose a well-structured and professional email "
            f"to {contact.firstName} {contact.lastName} ({contact.email}) regarding the following purpose:\n"
            f"{purpose}.\n\n"
            f"The email should:\n"
            f"- Begin with a polite and formal greeting, such as 'Dear {contact.firstName} {contact.lastName},'.\n"
            f"- Clearly explain the context or purpose of the email.\n"
            f"- Include any necessary details or questions related to the purpose.\n"
            f"- Conclude with a polite and professional closing statement.\n\n"
            f"Ensure the tone is courteous, concise, and professional.\n"
            f"Output the email in this format:\n"
            f"Subject: [A concise and relevant subject line]\n\n"
            f"[Greeting]\n\n"
            f"[Body of the email with clear and concise sentences.]\n\n"
            f"[Closing statement]\n\n"
            f"Best regards,\nLyle")
